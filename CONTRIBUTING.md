# Welcome to SenseCAP Watcher contributing guide <!-- omit in toc -->
...
If you found a problem, [search if an issue already exists](https://docs.github.com/en/github/searching-for-information-on-github/searching-on-github/searching-issues-and-pull-requests#search-by-the-title-body-or-comments). If a related issue doesn't exist, you can open a new issue using a relevant [issue form](https://github.com/Seeed-Studio/OSHW-SenseCAP-Watcher/issues/new/choose). 

#### Solve an issue

Scan through our [existing issues](https://github.com/Seeed-Studio/OSHW-SenseCAP-Watcher/issues) to find one that interests you.
...
Congratulations :tada::tada: The Seeed Studio team thanks you :sparkles:.